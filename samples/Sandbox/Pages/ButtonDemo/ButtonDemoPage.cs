                ...
                CreateSection("Icon Leading (Default Position)",
                    new VStack(
                        ...
                        new Button()
                            ...
                            .SetPadding(new Margin(15, 10))
                            .SetBackground(new SolidColorBackground(SKColors.DarkOrange))
                            .SetCornerRadius(8)
                            .SetMargin(new Margin(0, 5))
                    )
                ),
                ...
                CreateSection("Icon Trailing",
                    new VStack(
                        ...
                        new Button()
                            ...
                            .SetTextSize(16)
                            .SetPadding(new Margin(18, 12))
                            .SetBackground(new SolidColorBackground(SKColors.MediumPurple))
                            .SetCornerRadius(8)
                            .SetMargin(new Margin(0, 5)),
                        new Button()
                            .SetText("Submit")
                ...
                CreateSection("Icons on Both Sides",
                    new VStack(
                        new Button()
                            ...
                            .SetPadding(new Margin(15, 10))
                            .SetBackground(new SolidColorBackground(SKColors.DarkGoldenrod))
                            .SetCornerRadius(8)
                            .SetMargin(new Margin(0, 5)),
                        new Button()
                            ...
                            .SetTextSize(18)
                            .SetPadding(new Margin(20, 12))
                            .SetBackground(new SolidColorBackground(SKColors.DarkMagenta))
                            .SetCornerRadius(8)
                            .SetMargin(new Margin(0, 5))
                    )
                ),
                    ...
                    new Grid()
                        ...
                        .AddChild(
                            new Button()
                                ...
                                .SetBackground(new SolidColorBackground(SKColors.CornflowerBlue))
                                .SetCornerRadius(6)
                                .SetMargin(new Margin(5)))
                        .AddChild(
                            new Button()
                                ...
                                .SetBackground(new SolidColorBackground(SKColors.MediumSlateBlue))
                                .SetCornerRadius(8)
                                .SetMargin(new Margin(5)),
                            1, 0)
                        .AddChild(
                        ...
                        .AddChild(
                            new Button()
                                ...
                                .SetBackground(new SolidColorBackground(SKColors.IndianRed))
                                .SetCornerRadius(20)
                                .SetMargin(new Margin(5)),
                            0, 1)
                        .AddChild(
                            new Button()
                                ...
                                .SetTextSize(16)
                                .SetPadding(new Margin(12))
                                .SetBackground(new SolidColorBackground(SKColors.Tomato))
                                .SetCornerRadius(25)
                                .SetMargin(new Margin(5)),
                            1, 1)
                        .AddChild(
