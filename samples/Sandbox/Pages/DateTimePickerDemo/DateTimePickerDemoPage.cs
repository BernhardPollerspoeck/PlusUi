            ...
            new VStack(
                        ...
                        new VStack(
                            ...
                            new HStack(
                                new Label()
                                    ...
                                    .SetTextColor(Colors.Gray),
                                new Label()
                                    .BindText(() => vm.FormDate != null ? vm.FormDate.Value.ToString("dd.MM.yyyy") : "(none)")
                                    .SetTextSize(14)
                            ...
                            new HStack(
                                new Label()
                                    ...
                                    .SetTextColor(Colors.Gray),
                                new Label()
                                    .BindText(() => vm.FormTime != null ? vm.FormTime.Value.ToString("HH:mm") : "(none)")
                                    .SetTextSize(14)
                ...
                CreateSection("Basic DatePicker",
                    new DatePicker()
                        ...
                        .BindSelectedDate(() => vm.FormDate, d => vm.FormDate = d)
                ...
                CreateSection("DatePicker with Date Range (2024 only)",
                    new DatePicker()
                        ...
                        .BindSelectedDate(() => vm.SelectedDate, d => vm.SelectedDate = d)
                        .SetDesiredSize(new Size(220, 40))
                        .SetBackground(new SolidColorBackground(new Color(50, 50, 50)))
                        .SetCornerRadius(8)
                ),
                ...
                CreateSection("Future Appointment (Min: Tomorrow)",
                    new DatePicker()
                        ...
                        .BindSelectedDate(() => vm.AppointmentDate, d => vm.AppointmentDate = d)
                        .SetTextColor(Colors.LimeGreen)
                        .SetDesiredSize(new Size(250, 40))
                ...
                CreateSection("Basic TimePicker (24-hour)",
                    new TimePicker()
                        ...
                        .BindSelectedTime(() => vm.FormTime, t => vm.FormTime = t)
                ...
                CreateSection("12-Hour Format (AM/PM)",
                    new TimePicker()
                        ...
                        .BindSelectedTime(() => vm.SelectedTime, t => vm.SelectedTime = t)
                        .SetTextColor(Colors.Cyan)
                ...
                CreateSection("Business Hours (9:00 - 17:00)",
                    new TimePicker()
                        ...
                        .BindSelectedTime(() => vm.AppointmentTime, t => vm.AppointmentTime = t)
                        .SetTextColor(Colors.LimeGreen)
                        .SetDesiredSize(new Size(180, 40))
                        .SetBackground(new SolidColorBackground(new Color(30, 50, 30)))
                        .SetCornerRadius(8)
