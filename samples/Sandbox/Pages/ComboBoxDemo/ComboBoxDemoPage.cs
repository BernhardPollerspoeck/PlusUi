        ...
        return new ScrollView(
            new VStack(
                        ...
                        new VStack(
                            ...
                            new HStack(
                                new Label()
                                    ...
                                    .SetTextColor(Colors.Gray),
                                new Label()
                                    .BindText(() => vm.SelectedFruit != null ? vm.SelectedFruit : "(none)")
                                    .SetTextSize(14)
                            ...
                            new HStack(
                                new Label()
                                    ...
                                    .SetTextColor(Colors.Gray),
                                new Label()
                                    .BindText(() => vm.SelectedColor != null ? vm.SelectedColor : "(none)")
                                    .SetTextSize(14)
                            ...
                            new HStack(
                                new Label()
                                    ...
                                    .SetTextColor(Colors.Gray),
                                new Label()
                                    .BindText(() => vm.SelectedPerson != null ? vm.SelectedPerson.Name : "(none)")
                                    .SetTextSize(14)
                            ...
                            new HStack(
                                new Label()
                                    ...
                                    .SetTextColor(Colors.Gray),
                                new Label()
                                    .BindText(() => vm.SelectedCountryIndex.ToString())
                                    .SetTextSize(14)
                ...
                CreateSection("Basic ComboBox with Placeholder",
                    new ComboBox<string>()
                        .BindItemsSource(() => vm.Fruits)
                        .SetPlaceholder("Select a fruit...")
                        .BindSelectedItem(() => vm.SelectedFruit, f => vm.SelectedFruit = f)
                ...
                CreateSection("Custom Styled ComboBox",
                    new ComboBox<string>()
                        .BindItemsSource(() => vm.Colors)
                        .SetPlaceholder("Pick a color...")
                        .BindSelectedItem(() => vm.SelectedColor, c => vm.SelectedColor = c)
                        .SetTextColor(Colors.Cyan)
                ...
                CreateSection("ComboBox with Custom Display (Person objects)",
                    new ComboBox<Person>()
                        .BindItemsSource(() => vm.People)
                        .SetDisplayFunc(p => $"{p.Name} ({p.Age} years)")
                        .SetPlaceholder("Select a person...")
                        .BindSelectedItem(() => vm.SelectedPerson, p => vm.SelectedPerson = p)
                        .SetTextColor(Colors.Orange)
                ...
                CreateSection("ComboBox with Index Binding",
                    new ComboBox<string>()
                        ...
                        .BindSelectedIndex(() => vm.SelectedCountryIndex, i => vm.SelectedCountryIndex = i)
                        .SetTextColor(Colors.Pink)
                        .SetDesiredSize(new Size(250, 40))
