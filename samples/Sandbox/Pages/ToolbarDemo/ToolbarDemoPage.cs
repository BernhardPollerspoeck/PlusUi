            ...
            new VStack(
                ...
                CreateSection("Social Actions (Like, Bookmark, Share)",
                    new Toolbar()
                        ...
                        .SetDesiredHeight(56)
                        .SetBackground(new SolidColorBackground(Colors.DeepPink))
                        .SetTitleColor(Colors.White)
                ),
                ...
                CreateSection("Custom Item Spacing",
                    new Toolbar()
                        ...
                        .AddRight(CreateIconButton("plusui.png"))
                        .SetDesiredHeight(56)
                        .SetBackground(new SolidColorBackground(Colors.Indigo))
                        .SetTitleColor(Colors.White)
                ),
                ...
                CreateSection("Custom Content Padding",
                    new Toolbar()
                        ...
                        .AddRight(CreateIconButton("plusui.png"))
                        .SetDesiredHeight(56)
                        .SetBackground(new SolidColorBackground(Colors.DarkOliveGreen))
                        .SetTitleColor(Colors.White)
                ),
                ...
                CreateSection("Overflow Behavior - Click the overflow button (...)!",
                    new Toolbar()
                        ...
                        .AddLeft(new Button().SetText("File").SetPadding(new Margin(12, 8)).SetBackground(new SolidColorBackground(Colors.Transparent)).SetTextColor(Colors.White).SetVerticalAlignment(VerticalAlignment.Center))
                        .AddLeft(new Button().SetText("Edit").SetPadding(new Margin(12, 8)).SetBackground(new SolidColorBackground(Colors.Transparent)).SetTextColor(Colors.White).SetVerticalAlignment(VerticalAlignment.Center))
                        .AddLeft(new Button().SetText("View").SetPadding(new Margin(12, 8)).SetBackground(new SolidColorBackground(Colors.Transparent)).SetTextColor(Colors.White).SetVerticalAlignment(VerticalAlignment.Center))
                        .AddLeft(new Button().SetText("Tools").SetPadding(new Margin(12, 8)).SetBackground(new SolidColorBackground(Colors.Transparent)).SetTextColor(Colors.White).SetVerticalAlignment(VerticalAlignment.Center))
                        .AddRight(new Button().SetText("Search").SetPadding(new Margin(12, 8)).SetBackground(new SolidColorBackground(Colors.Transparent)).SetTextColor(Colors.White).SetVerticalAlignment(VerticalAlignment.Center))
                        .AddRight(new Button().SetText("Settings").SetPadding(new Margin(12, 8)).SetBackground(new SolidColorBackground(Colors.Transparent)).SetTextColor(Colors.White).SetVerticalAlignment(VerticalAlignment.Center))
                        .AddRight(new Button().SetText("Help").SetPadding(new Margin(12, 8)).SetBackground(new SolidColorBackground(Colors.Transparent)).SetTextColor(Colors.White).SetVerticalAlignment(VerticalAlignment.Center))
                        .AddRight(new Button().SetText("About").SetPadding(new Margin(12, 8)).SetBackground(new SolidColorBackground(Colors.Transparent)).SetTextColor(Colors.White).SetVerticalAlignment(VerticalAlignment.Center))
                        .SetDesiredHeight(56)
                ...
                CreateSection("Toolbar with Center Content",
                    new Toolbar()
                        ...
                        .AddRight(CreateIconButton("plusui.png"))
                        .SetDesiredHeight(56)
                        .SetBackground(new SolidColorBackground(Colors.CadetBlue))
                ),
