                    ...
                    new VStack(
                        ...
                        new LongPressGestureDetector(
                            new Border()
                                ...
                                .SetBackground(new SolidColorBackground(new SKColor(180, 50, 50)))
                                .SetCornerRadius(8)
                        )
                    ...
                    new VStack(
                        ...
                        new DoubleTapGestureDetector(
                            new Border()
                                ...
                                .SetBackground(new SolidColorBackground(new SKColor(50, 100, 180)))
                                .SetCornerRadius(8)
                        )
                    ...
                    new VStack(
                        ...
                        new SwipeGestureDetector(
                            new Border()
                                ...
                                .SetBackground(new SolidColorBackground(new SKColor(50, 150, 80)))
                                .SetCornerRadius(8)
                    ...
                    new VStack(
                        ...
                        new PinchGestureDetector(
                            new Border()
                                ...
                                .SetBackground(new SolidColorBackground(new SKColor(150, 80, 180)))
                                .SetCornerRadius(8)
                                .SetDesiredSize(new Size(200, 100))
                        )
                ...
                CreateSection("Haptic Feedback",
                    new VStack(
                        new Label()
                            ...
                            .SetTextSize(14)
                            .SetTextColor(vm.HapticsSupported ? SKColors.LimeGreen : SKColors.Orange)
                            .SetMargin(new Margin(0, 0, 0, 10)),
                        new HStack(
                            new Button()
                                .SetText("Light")
                                ...
                                .SetBackground(new SolidColorBackground(new SKColor(60, 60, 60)))
                                .SetCornerRadius(4)
                            ...
                            new Button()
                                ...
                                .SetTextColor(SKColors.White)
                                .SetPadding(new Margin(10, 6))
                                .SetBackground(new SolidColorBackground(new SKColor(100, 100, 100)))
                                .SetCornerRadius(4)
                        ),
                        new HStack(
                            new Button()
                                ...
                                .SetTextColor(SKColors.White)
                                .SetPadding(new Margin(10, 6))
                                .SetBackground(new SolidColorBackground(new SKColor(50, 150, 50)))
                                .SetCornerRadius(4)
                                .SetMargin(new Margin(0, 0, 5, 0)),
                            new Button()
                                .SetText("Warning")
                                ...
                                .SetTextColor(SKColors.White)
                                .SetPadding(new Margin(10, 6))
                                .SetBackground(new SolidColorBackground(new SKColor(200, 150, 50)))
                                .SetCornerRadius(4)
                                .SetMargin(new Margin(0, 0, 5, 0)),
                            new Button()
                                .SetText("Error")
