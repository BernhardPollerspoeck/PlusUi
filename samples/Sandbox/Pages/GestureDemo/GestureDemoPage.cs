            ...
            new VStack(
                ...
                CreateSection("LongPress Gesture",
                    new VStack(
                                ...
                                .AddChild(
                                    new VStack(
                                        new Label()
                                            ...
                                            .SetTextColor(Colors.White),
                                        new Label()
                                            .BindText(() => $"Count: {vm.LongPressCount}")
                                            .SetTextSize(14)
                        ...
                        .BindCommand(() => vm.LongPressCommand)
                    )
                ),
                ...
                CreateSection("DoubleTap Gesture",
                    new VStack(
                                ...
                                .AddChild(
                                    new VStack(
                                        new Label()
                                            ...
                                            .SetTextColor(Colors.White),
                                        new Label()
                                            .BindText(() => $"Count: {vm.DoubleTapCount}")
                                            .SetTextSize(14)
                                            .SetTextColor(Colors.LightGray)
                                    ).SetMargin(new Margin(20))
                                )
                        ...
                        .BindCommand(() => vm.DoubleTapCommand)
                    )
                ),
                                ...
                                .AddChild(
                                    new VStack(
                                        new Label()
                                            ...
                                            .SetTextColor(Colors.White),
                                        new Label()
                                            .BindText(() => $"Direction: {vm.SwipeDirection}")
                                            .SetTextSize(14)
                                            .SetTextColor(Colors.LightGray)
                                    ).SetMargin(new Margin(20))
                                )
                                ...
                                .AddChild(
                                    new VStack(
                                        new Label()
                                            ...
                                            .SetTextColor(Colors.White),
                                        new Label()
                                            .BindText(() => $"Scale: {vm.PinchScale:F2}")
                                            .SetTextSize(14)
                                            .SetTextColor(Colors.LightGray)
                                    ).SetMargin(new Margin(20))
                                )
