                ...
                CreateSection("Payment Method (Custom Styling)",
                    new VStack(
                        new RadioButton()
                            ...
                            .SetCircleColor(SKColors.LightGreen)
                            .SetSelectedColor(SKColors.Green)
                        ...
                        new RadioButton()
                            ...
                            .SetCircleColor(SKColors.LightBlue)
                            .SetSelectedColor(SKColors.DodgerBlue)
                        ...
                        new RadioButton()
                            ...
                            .SetCircleColor(SKColors.Orange)
                            .SetSelectedColor(SKColors.OrangeRed)
