    ...
    protected override UiElement Build()
    {
        return new VStack(
            ...
            new Grid()
                ...
                .AddChild(LinkCard("Docs", "plusui.qsp.app", new Color(78, 201, 176)), 0, 1)
                .AddChild(LinkCard("Discord", "discord.gg/Je3kNpcmqn", new Color(140, 120, 220)), 1, 0)
                .AddChild(LinkCard("NuGet", "nuget.org/profiles/BernhardPollerspoeck", new Color(200, 130, 50)), 1, 1)
        )
        .SetSpacing(0)
        .SetHorizontalAlignment(HorizontalAlignment.Left)
