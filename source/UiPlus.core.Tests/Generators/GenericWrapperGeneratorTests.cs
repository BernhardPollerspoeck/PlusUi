...
namespace PlusUi.core
{
    ...
    public void GeneratedCode_SupportsMethodChaining()
    {
        ...
        foreach (var method in chainableMethods)
        {
            ...
            var methodBody = nextMethodIndex > 0
                ? generatedCode[methodIndex..nextMethodIndex]
                : generatedCode[methodIndex..];
    ...
    private static string CreateUiElementSource()
    {
        return @"
using System;
using PlusUi.SourceGenerators;
...
namespace PlusUi.core
{
    ...
    private static GeneratorDriverRunResult RunGenerator(string source)
    {
        ...
        driver = driver.RunGeneratorsAndUpdateCompilation(compilation, out _, out var _);
