...
public class ItemsListTests
{
    ...
    public void TestItemsList_StretchButtons_ShouldRespectMargins()
    {
        ...
        Assert.IsGreaterThanOrEqualTo(1, buttons.Count, "Should have at least one button");
    ...
    public void TestItemsList_InMainPageLayout_AllButtonsShouldHaveSameWidth()
    {
        ...
        // Get all buttons
        var buttons = itemsList.Children.OfType<Button>().ToList();
        Assert.IsGreaterThanOrEqualTo(2, buttons.Count, $"Should have at least 2 visible buttons, got {buttons.Count}");
    ...
    public void TestItemsList_ButtonWidthShouldBeConsistentAfterScrollingDownAndBackUp()
    {
        ...
        Assert.IsGreaterThanOrEqualTo(1, initialButtons.Count, "Should have at least 1 visible button initially");
        ...
        Assert.IsGreaterThanOrEqualTo(1, buttonsAfterScroll.Count, "Should have at least 1 visible button after scrolling");
    ...
    public void TestItemsList_ButtonWidthShouldBeConsistentAfterScrolling()
    {
        ...
        Assert.IsGreaterThanOrEqualTo(1, scrolledButtons.Count, "Should have at least 1 visible button after scrolling");
